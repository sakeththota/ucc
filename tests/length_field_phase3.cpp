...
namespace uc {
  ...
  void test_default() {
    UC_REFERENCE(foo) var0 = uc_make_object<UC_REFERENCE(foo)>();
    UC_REFERENCE(foo) var0b = uc_make_object<UC_REFERENCE(foo)>();
    assert(var0 == var0b);
    assert(!(var0 != var0b));
  ...
  void test_non_default_with_defaults() {
    UC_REFERENCE(foo) var0 = uc_make_object<UC_REFERENCE(foo)>(UC_PRIMITIVE(int){},
                                                               UC_PRIMITIVE(string){});
    assert(var0->UC_VAR(x) == UC_PRIMITIVE(int){});
    assert(var0->UC_VAR(length) == UC_PRIMITIVE(string){});
  }
  ...
  void test_non_default_with_non_defaults() {
    ...
    UC_REFERENCE(foo) var0 = uc_make_object<UC_REFERENCE(foo)>(arg0_0,
                                                               arg0_1);
    UC_REFERENCE(foo) var0b = uc_make_object<UC_REFERENCE(foo)>(arg0_0,
                                                                arg0_1);
    UC_REFERENCE(foo) var0c = uc_make_object<UC_REFERENCE(foo)>(arg0_0c,
                                                                arg0_1c);
    assert(var0 == var0b);
    assert(!(var0 != var0b));
    assert(var0 != var0c);
